import logo from '../assets/logo.webp';  // Ruta del logo
...
export const Navbar = () => {
  return (
    ...
    <div className='flex items-center font-bold gap-60 text-white'>
        ...
        <div className='flex gap-3 items-center border-2 px-10 py-2 rounded-3xl cursor-pointer hover:bg-green-500 hover:scale-105 transition-transform duration-300'>
