...
const SocialCard = ({ nombre, mensaje, icono }) => {
  return (
    <div
      className="flex items-center justify-between w-full gap-4 p-6 transition-all duration-300 ease-in-out shadow-sm rounded-2xl bg-white/70 backdrop-blur-sm hover:shadow-lg hover:scale-105 sm:max-w-md"
    >
      {/* Icono */}
